...
3. **Correctie tegen audio** (handmatig — corrigeren gaat sneller met context)
4. **Kandidatenlijst identificatoren genereren** (script: `find_entities.py`, spaCy)
5. **Handmatige aanvulling kandidatenlijst**
...
- **Open beslissing (Route 1, bevestiging Bekir pending):** organisatienamen wel of niet behouden. Script moet beide aankunnen: 
...
4. Docx in `output/` te importeren in Atlas.ti.
